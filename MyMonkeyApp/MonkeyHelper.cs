...
public static class MonkeyHelper
{
    ...
    public static Monkey GetRandomMonkey()
    {
        ...
        var monkey = monkeys[idx];
        if (!randomViewCounts.ContainsKey(monkey.Name))
            randomViewCounts[monkey.Name] = 0;
        randomViewCounts[monkey.Name]++;
        return monkey;
    }
    ...
    {
        return randomViewCounts.TryGetValue(name, out var count) ? count : 0;
    }
}
